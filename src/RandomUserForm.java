 ...
 */
public class RandomUserForm extends javax.swing.JFrame implements MyObserver {
  ...
  private void btn1Clicked(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1Clicked
      RandomUserControl random = new RandomUserControl();
      random.registerMyObserver(this);
  ...
  public static void main(String args[]) {
    ...
    @Override
    public void update(RandomUser random) {
